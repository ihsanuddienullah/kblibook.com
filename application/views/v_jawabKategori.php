...
<div>
  ...
  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 0%; color: #413e66; text-align: center">0%</div>
</div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input  type="search" class="form-control" id="search" placeholder="Cari Deskripsi Usaha" />
                    </div>
                  </div>
                  <table class="col-12">
                      ...
                      if( ! empty($kategori)){
                        ...
                        foreach($kategori as $data){
                          ?>
                                  ...
                                  <div class="card ">
                                      <div class="card-header">
                                        <div class="row">
                                          ...
                                          <div class="col-1">
                                          <input type="checkbox" class="kode" name="check_list[]" alt="Checkbox" value="<?php echo $data->kode_kategori;?>">
                                          </div>
                                        </div>
                                        
                                      </div>
                                    <div class="card-body">
                                      <p style="font-size:20px;font-weight: bold;">USAHA SAYA TENTANG <?php echo $data->judul_kategori?></p>
                                      </br>
                                      <div class="text-right mb-3">
                                        <a href="#detail<?php echo $data->kode_kategori;?>" data-toggle="modal" class="btn btn-info right">Lihat Detail</a>
                                      </div>
                            ...
                            <!--Detail Modal -->
                            <div id="detail<?php echo $data->kode_kategori; ?>" class="modal fade" role="dialog">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                              
                                <p style="font-size:20px;font-weight: bold;"><?php echo $data->judul_kategori?></p>
                              ...
                              <?php echo $data->deskripsi_kategori?></p>
