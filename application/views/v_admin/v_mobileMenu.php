                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">KBLI <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="<?php echo base_url('index.php/Kategori/index'); ?>">Tambah KBLI</a></li>
                                                <li><a href="<?php echo base_url('index.php/Kategori/view'); ?>">Table KBLI</a></li>
                                            </ul>
                                        </li>
