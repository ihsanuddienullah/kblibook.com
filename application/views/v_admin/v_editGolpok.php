                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Edit Golongan Pokok</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description"> Edit Golongan Pokok</a></li>
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    
                                    <form id="acount-infor" method="post" action="<?php echo base_url('index.php/Kategori/ubahGolpok'); ?>" class="acount-infor">
                                        <?php foreach($Golpok as $data){?>
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="review-content-section">
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <input readonly="readonly" type="text" class="form-control" name="kode_golonganpokok" placeholder="kode_golonganpokok" value="<?php echo $data->kode_golonganpokok ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <select name="kode_kategori" class="form-control" required="">
                                                                            ...
                                                                            <?php
                                                                                if( ! empty($kategori)){ 
                                                                                    ...
                                                                                    echo 
                                                                                    "<option value='".$data2->kode_kategori."'>".$data2->kode_kategori."</option>";
                                                                                    }
                                                                                }else{ 
                                                                ...
                                                                <div class="form-group">
                                                                    <input required="" type="text" class="form-control" name="judul_golonganpokok" placeholder="judul_golonganpokok" value="<?php echo $data->judul_golonganpokok ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    
                                                                    <textarea  required="" id="summernote" name="deskripsi_golonganpokok" type="text" class="form-control" placeholder="deskripsi_golonganpokok" ><?php echo $data->deskripsi_golonganpokok ?></textarea >
                                                                </div>
