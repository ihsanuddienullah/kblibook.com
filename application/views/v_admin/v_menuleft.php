            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a title="Dashboard" href="<?php echo base_url('index.php/admin/index'); ?>" aria-expanded="false"><span class="educate-icon educate-home icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Dashboard</span></a>
                        </li>
                        <li>
                            <a class="has-arrow" href=""<?php echo base_url('index.php/Kategori/index'); ?>"" aria-expanded="false"><span class="educate-icon educate-course icon-wrap"></span> <span class="mini-click-non">KBLI</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Tambah Kategori" href="<?php echo base_url('index.php/Kategori/index'); ?>"><span class="mini-sub-pro">Tambah KBLI</span></a></li>
                                <li><a title="Table Kategori" href="<?php echo base_url('index.php/Kategori/view'); ?>"><span class="mini-sub-pro">Tabel KBLI</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li >
                            <a title="Saran" href="<?php echo base_url('index.php/Saran/index'); ?>" aria-expanded="false"><span class="educate-icon educate-message icon-wrap" aria-hidden="true"></span> <span class="mini-click-non">Saran</span></a>
                        </li>
                        <li >
                            <a title="website" href="<?php echo base_url('index.php/kbli/index'); ?>" target="_blank" aria-expanded="false"><span class="educate-icon educate-apps icon-wrap" aria-hidden="true"></span> <span class="mini-click-non">Lihat website</span></a>
                        </li>
                        <li >
                            <a title="website" href="<?php echo base_url('index.php/login/logout'); ?>"  aria-expanded="false"><span class="educate-icon educate-pages icon-wrap" aria-hidden="true"></span> <span class="mini-click-non">Logout</span></a>
                        </li>
                        <!-- <li>
