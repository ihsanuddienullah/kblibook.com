                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Edit Sub Golongan</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description"> Edit Sub Golongan</a></li>
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    
                                    <form id="acount-infor" method="post" action="<?php echo base_url('index.php/Kategori/ubahSubgol'); ?>" class="acount-infor">
                                        <?php foreach($Subgol as $data2){?>
                                            
                                                <div class="devit-card-custom">
                                                    <div class="form-group">
                                                        <input readonly="readonly" type="text" class="form-control" name="kode_subgolongan" placeholder="kode_subgolongan" value="<?php echo $data2->kode_subgolongan ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <select name="kode_golongan" class="form-control" required="">
                                                                ...
                                                                <?php
                                                                    if( ! empty($gol)){ // Jika data siswa tidak sama dengan kosong, artinya jika data siswa ada
                                                                        ...
                                                                        echo 
                                                                        "<option value='".$data->kode_golongan."'>".$data->kode_golongan."</option>";
                                                                        }
                                                                    }else{ 
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="judul_subgolongan" placeholder="judul_subgolongan" value="<?php echo $data2->judul_subgolongan ?>" required="">
                                                    </div>
                                                    <div class="form-group">
                                                    <textarea  id="summernote" name="deskripsi_subgolongan" type="text" class="form-control" placeholder="deskripsi_subgolongan" required=""><?php echo $data2->deskripsi_subgolongan ?></textarea >
