                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Edit Golongan</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description"> Edit Golongan</a></li>
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    
                                <form id="acount-infor" method="post" action="<?php echo base_url('index.php/Kategori/ubahGol'); ?>" class="acount-infor">
                                <?php foreach($Gol as $data){?>
                                    <div class="devit-card-custom">
                                        <div class="form-group">
                                            <input readonly="readonly" type="text" class="form-control" name="kode_golongan" placeholder="kode_golongan" value="<?php echo $data->kode_golongan ?>">
                                        </div>
                                        <div class="form-group">
                                            <select name="kode_golonganpokok" class="form-control" required="">
                                                    ...
                                                    <?php
                                                        if( ! empty($golPok)){ // Jika data siswa tidak sama dengan kosong, artinya jika data siswa ada
                                                            ...
                                                            foreach($golPok as $data2){
                                                    
                                                            echo 
                                                            "<option value='".$data2->kode_golonganpokok."'>".$data2->kode_golonganpokok."</option>";
                                                            }
                                                        }else{ 
                                        ...
                                        <div class="form-group">
                                            <input required="" type="text" class="form-control" name="judul_golongan" placeholder="judul_golongan" value="<?php echo $data->judul_golongan ?>">
                                        </div>
                                        <div class="form-group">
                                           
                                            <textarea required="" id="summernote" name="deskripsi_golongan" type="text" class="form-control" placeholder="deskripsi_golongan" ><?php echo $data->deskripsi_golongan ?></textarea >
                                        </div>
