...
<div>
  <div class="containertable" style="margin: 0 auto;width:70%">
    <div class="row d-flex justify-content-center">
      ...
      <form action="<?php echo site_url('index.php/QNA/kesimpulan')?>" id="myform" method="post"  class="acount-infor add-admin formkategori">
            <div class="container">
  ...
  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 80%; color: white; text-align: center">80%</div>
</div>
                          ...
                          <div class="card ">
                              <div class="card-header">
                                <div class="row">
                                  ...
                                  <div class="col-1">
                                  <input type="checkbox" class="kode" name="check_list[]" alt="Checkbox" value="<?php echo $data->kode_kelompok;?>">
                                  </div>
                                </div>
                                
                              </div>
                            <div class="card-body">
                              <p style="font-size:20px;font-weight: bold;">USAHA SAYA TENTANG <?php echo $data->judul_kelompok?></p>
                              </br>
