...
<div>
  <div class="containertable" style="margin: 0 auto;width:70%">
    <div class="row d-flex justify-content-center">
      ...
      <form action="<?php echo site_url('index.php/QNA/jawabSubGol')?>" id="myform" method="post"  class="acount-infor add-admin formkategori">
      <div class="container">
  ...
  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 40%; color: white; text-align: center">40%</div>
</div>
              ...
              <?php
                if( ! empty($gol)){
                  ...
                  foreach($gol as $data){
                          ...
                          <div class="card ">
                              <div class="card-header">
                                <div class="row">
                                  ...
                                  <div class="col-1">
                                  <input type="checkbox" class="kode" name="check_list[]" alt="Checkbox" value="<?php echo $data->kode_golongan;?>">
                                  </div>
                                </div>
                                
                              </div>
                            <div class="card-body">
                              <p style="font-size:20px;font-weight: bold;">USAHA SAYA TENTANG <?php echo $data->judul_golongan?></p>
                              </br>
                              <div class="text-right mb-3">
                                <a href="#detail<?php echo $data->kode_golongan;?>" data-toggle="modal" class="btn btn-info right">Lihat Detail</a>
                              </div>
                    ...
                    <!--Detail Modal -->
                    <div id="detail<?php echo $data->kode_golongan; ?>" class="modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <p style="font-size:20px;font-weight: bold;"><?php echo $data->judul_golongan?></p>
                      ...
                      <?php echo $data->deskripsi_golongan?></p>  
