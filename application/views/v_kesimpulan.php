...
<div>
  <div class="containertable" style="margin: 0 auto;width:70%">
    <div class="row d-flex justify-content-center">
      ...
      <form action="<?php echo site_url('index.php/QNA/jawabgolPok')?>" id="myform" method="post"  class="acount-infor add-admin formkategori">
            <div class="container">
  ...
  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 100%; color: white; text-align: center">100%</div>
</div>
						  
                      </div>
                    <div class="card-body">
                      <h5 class="card-title" style="text-align: center">KODE KBLI USAHA ANDA ADALAH : </h5>
                    </div>
                  </div>
                  </br>
                    ...
                    <tbody>
                      ...
                      if( ! empty($kel)){ // Jika data siswa tidak sama dengan kosong, artinya jika data siswa ada
                        foreach($kel as $data){
                                ...
                                <div class=" items" style="padding-bottom: 20px;">
                                  <div class="card ">
                                      <div class="card-header">
                                        <div class="row">
                                          <div class="col-12">
                                            <strong>Kode : <?php echo $data->kode_kelompok?></strong>
                                    ...
                                    <div class="card-body">
                                      <p style="font-size:20px;font-weight: bold;"><?php echo $data->judul_kelompok?></p>
                                      </br>
                                      <div class="text-right mb-3">
                                        <a href="#detail<?php echo $data->kode_kelompok;?>" data-toggle="modal" class="btn btn-info right">Lihat Detail</a>
                                      </div>
                            ...
                            <!--Detail Modal -->
                            <div id="detail<?php echo $data->kode_kelompok; ?>" class="modal fade" role="dialog">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <p style="font-size:20px;font-weight: bold;"><?php echo $data->judul_kelompok?> (<?php echo $data->kode_kelompok?>)</p>
                              ...
                              <?php echo $data->deskripsi_kelompok?></p>
                              <p> <p><strong>Contoh Pekerjaan: </strong></br>
                              <?php echo $data->contoh_pekerjaan?>
                              </p>
                  ...
                  <div class="row justify-content-md-end" style="padding-right: 5px">
                    <div class="tombol">
                      <input formaction="<?php echo base_url('index.php/QNA/index'); ?>" style="margin: 10px; " class="btn btn-danger waves-effect waves-light float-left" type="submit" value="Kembali">
